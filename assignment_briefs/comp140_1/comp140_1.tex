...
\todo[inline]{TODO repository URL}
...
\todo[inline]{TODO physical submission?}
...
\todo[inline]{TODO more resources?}
...
%        \grade\fail The final design and construction are not documented, or documentation is inappropriate.
%            \par Source code is unmaintainable.
%        \grade The final design and construction are documented, but with major gaps that prevent reproduction.
%            \par Source code is not well structured.
%                Names are unclear. Comments are not used.
%        \grade The final design and construction are documented, but would be difficult to reproduce.
%            \par Source code is not well structured.
%                Names are sometimes unclear. Comments are used.
%        \grade The final design and construction are documented satisfactorily, and could be reproduced with much effort.
%            \par Source code is reasonably well structured.
%                Names are mostly clear. Comments are reasonably effective.
%        \grade The final design and construction are documented effectively, and could be reproduced with some effort.
...
%        \grade The final design and construction are documented comprehensively, and could easily be reproduced.
