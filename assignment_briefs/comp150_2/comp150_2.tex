...
\begin{markingrubric}
    ...
    \criterion{Appropriateness of user stories and sprint planning}{10\% $\dagger$}
    ...
    \criterion{Portability and Project Structure}{5\% $\dagger$}
        ...
        \grade Almost no portability issues are present.
            \par The provided template has mostly been followed exactly.
    \criterion{Professionalism}{5\% $\dagger$}
