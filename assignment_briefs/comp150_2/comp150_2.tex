...
\todo[inline]{$\uparrow$ Mike --- I'm assuming this is the case?}
...
\begin{markingrubric}
    ...
    \criterion{Appropriateness of user stories and sprint planning}{15\% $\dagger$}
    ...
    \criterion{Innovation and creative flair}{10\% $\dagger$}
    ...
    \criterion{Professionalism}{10\% $\dagger$}
    ...
    \criterion{Use of version control}{5\% $\dagger$}
