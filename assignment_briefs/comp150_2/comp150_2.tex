...
\begin{markingrubric}
    \firstcriterion{Individual pitches}{10\%}
        \grade\fail F
        \grade D
        \grade C
        \grade B
        \grade A
        \grade A$^*$
    \criterion{Individual contribution}{Multiplier for criteria below}
        \gradespan{5}{\fail Bad}
        \grade Good
    \criterion{Sprint reviews}{Threshold \par 5\% + 5\%}
    ...
    \criterion{Appropriateness of requirements}{10\%}
        \grade\fail F
        \grade D
        \grade C
        \grade B
    ...
    \criterion{Innovation and creative flair}{10\%}
        ...
        \grade A
        \grade A$^*$
    \criterion{Appropriateness of sprint planning}{10\%}
        \grade\fail F
        \grade D
        \grade C
        \grade B
