...
```{r results='asis'}
if (!html) {
  cat("\\title{\\sessionnumber: An Introduction Expert Usability Testing} \\subtitle{\\modulecode: \\moduletitle} \\frame{\\titlepage} ")
}
```
...
** It is common to rate usabilty issues on a scale from 0 to 4 **
...
- Looks like testing as UI Prototype is just as good as testing in engine
...
![](assets/ambient.png){ width=40% }
![](assets/VR.png){ width=40% }

![](assets/homeauto.png){ width=40% }

![](assets/elearning.png){ width=40% }
...
[The Nielson Standard](https://tfa.stanford.edu/download/TenUsabilityHeuristics.pdf)
