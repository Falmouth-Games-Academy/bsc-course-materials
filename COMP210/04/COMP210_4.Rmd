...
\title{\sessionnumber:  Visualisation \& Analysis of Results}
\subtitle{\modulecode: \moduletitle}

\frame{\titlepage} 

# Session 4: Visualisation & Analysis of Results
...
- **Utilise** descriptive statistics to explain your quantitative findings
- **Codify** qualitative data and find patterns and trends
- **Visualise** data using Excel of Google Sheets
...
- Based on solif theoretical framework (taxonomies)
